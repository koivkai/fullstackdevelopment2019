...
describe('total likes', () => {
  ...
  test('when list has many blogs is the sum of all the likes of the blogs in the list', () =>{
    expect(listHelper.totalLikes(manyBlogs)).toBe(36)
  })

  test('for an empty is is zero', () => {
...
describe('favoriteBlog', () => {
  ...
  test('when list has many blogs blog with most likes is returned', () => {
